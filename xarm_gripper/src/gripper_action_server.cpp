...
#include <xarm_gripper/GripperAction.h>
...
namespace xarm_control
{
	...
	protected:
	  ...
	  ros::NodeHandle nh_;
	  actionlib::SimpleActionServer<xarm_gripper::GripperAction> as_; // NodeHandle instance must be created before this line. Otherwise strange error occurs.
	  std::string action_name_;
	  // create messages that are used to published feedback/result
	  xarm_gripper::GripperFeedback feedback_;
	  xarm_gripper::GripperResult result_;
	...
	public:
	  ...
	  void executeCB(const xarm_gripper::GripperGoalConstPtr &goal);

	};

	void GripperAction::executeCB(const xarm_gripper::GripperGoalConstPtr &goal)
	  {
	    ros::Rate r(10);
	    int ret = 0;
